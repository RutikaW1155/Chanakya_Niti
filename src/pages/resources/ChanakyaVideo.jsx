...
const ChanakyaVideo = () => {
  return (
    <div className="video-section">
      <h2>Chanakya Video Section</h2>
      <div className="video-container">
        {/* First Video */}
        <iframe
          width="560"
          height="315"
          src="https://www.youtube.com/embed/0yBPo4-JydQ?si=CSoYAz7KqnJmtFjc"
          title="Chanakya Video 1"
          frameBorder="0"
        ...
        <iframe
          width="560"
          height="315"
          src="https://www.youtube.com/embed/yIehOJylev8?si=2VjYeeLZYg2B5tcY"
          title="Chanakya Video 2"
          frameBorder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          allowFullScreen
        ></iframe>
